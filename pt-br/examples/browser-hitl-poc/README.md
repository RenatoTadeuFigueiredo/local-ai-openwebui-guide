...
> [English](../../../examples/browser-hitl-poc/README.md) · **Português**
...
Documento que descreve este POC: [`../../docs/04-browser-hitl-multi-user-poc.md`](../../../docs/04-browser-hitl-multi-user-poc.md)